(function() {
  ...
  1: [function(require, module, exports) {
    ...
    (function() {
      ...
      /*----------------------------------------------------------------------------*/
      // debuging function
      var helloWorld = function helloWorld(a) {
        console.log(a);
      };
      var detectElement = function detectElement(a) {
        // element, color,
      ...
      helloWorld();
      detectElement('div');
      var intervarlRunner = function intervarlRunner() {
      ...
      function equilizeElementWidth(a, b) {
        // finds height of element (a) and sets height (a) to element (b) 
      ...
      function equilizeElementHeight(a, b) {
        // finds height of element (a) and sets height (a) to element (b) 
      ...
      ifScreenSize(960);
      // equilizer
      function equilizeContentBox() {
        // triggers functions on resize
      ...
      equilizeContentBox();
      $(window).resize(function() {
        // if windowe is resized
        // location.reload();
        screenSizeTrigger();
      });
      var ajaxForm = function ajaxForm(e) {
        e.preventDefault();
      ...
      var ajaxSuccess = function ajaxSuccess(data) {
        ...
        if (data.errors) {
          ...
          for (var i = 0; i < names.length; i++) {
            $('form').find('[name="' + names[i] + '"]').addClass('error');
          }
        } else {
